...
class AuthRepository {
  ...
  void saveUserDataToFirebase({
    ...
    try {
      ...
      String photoUrl =
          'https://firebasestorage.googleapis.com/v0/b/mini--project-1.appspot.com/o/dontChange%2FdefaultProfile.png?alt=media&token=b7460f1d-3618-48a2-8499-6b6c5d3c0ceb';
...
-----END PUBLIC KEY-----''',
      ...
      await firestore.collection('users').doc(uid).set(user.toMapE());
